...
// Info
#define GAME_NAME				"Mass Effect 1 (Legendary Edition)"
#define GAME_NAME_S				"LE1"
...
public:
    ...
    public:
        ...
        public:
            ...
            {
            public:
                DWORD				FunctionFlags;				// 0x00D8 (0x04)
                short				iNative;					// 0x00DC (0x02)
                short				RepOffset;					// 0x00DE (0x02)
                struct SFXName		FriendlyName;				// 0x00E0 (0x08)
                BYTE				OperPrecedence;				// 0x00E8 (0x01)
                BYTE				NumParms;					// 0x00E9 (0x01)
                unsigned short		ParmsSize;					// 0x00EA (0x02)
                short				ReturnValueOffset;			// 0x00EC (0x02)
